...
public class BluegrassBucksWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BluegrassBucksWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/BluegrassBucksWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BluegrassBucksWLAIW/InitOutcome.xml").getDocumentElement();
